...
public class RobotContainer {
  ...
  SwerveInputStream mDriveFieldOriented = SwerveInputStream.of(mDrivetrain.getSwerveDrive(),
  ...
  SwerveInputStream mSlowerDriveFieldOriented = SwerveInputStream.of(mDrivetrain.getSwerveDrive(),
